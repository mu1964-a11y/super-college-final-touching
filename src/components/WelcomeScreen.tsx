...
interface WelcomeScreenProps {
  ...
  onEnter: () => void;
  onDirectSelectPortal?: (portal: "student" | "staff" | "admin") => void;
}
...
export default function WelcomeScreen({
  ...
  const handleProceed = (roleToUse = selectedRole) => {
    if (onDirectSelectPortal) {
      onDirectSelectPortal(roleToUse);
    } else {
      onEnter();
    }
  };
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-3 sm:p-5 lg:p-7 font-sans select-none relative overflow-hidden text-slate-800">
      ...
      {/* Main Unified Portal Card (Expanded to approx. 1140-1180px for desktop authority) */}
      <motion.div
      ...
      >
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-[#064e43] via-[#053e35] to-[#022822] p-7 sm:p-9 lg:p-10 flex flex-col justify-between text-white relative overflow-hidden">
          {/* Subtle Background Watermark & Cap Silhouette */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3.5 mb-7 sm:mb-8">
              ...
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-semibold text-amber-200/90 tracking-wide">
                  Jahanian Main Campus &bull; Digital Platform
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-xs sm:text-[13px] text-emerald-100/85 mt-3 leading-relaxed max-w-md">
                Access your academic records, timetables, learning resources, and campus services &mdash; all in one place.
              </p>
            </div>

            {/* 3 Benefit Feature Pillars (Academic Records, Timetables, Campus Services) */}
            <div className="grid grid-cols-3 gap-3 pt-2">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[9.5px] sm:text-[10px] text-emerald-200/70 mt-1 leading-snug">
                  View your results, transcripts and academic progress.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[9.5px] sm:text-[10px] text-emerald-200/70 mt-1 leading-snug">
                  Stay updated with your class schedules and academic events.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[9.5px] sm:text-[10px] text-emerald-200/70 mt-1 leading-snug">
                  Access announcements, resources and essential campus services.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Bottom Slogan Line */}
          <div className="relative z-10 pt-6 mt-6 border-t border-emerald-700/40 text-center">
        ...
        <div className="lg:col-span-7 bg-white p-7 sm:p-9 lg:p-11 flex flex-col justify-between relative">
          ...
          <div className="my-auto py-5 flex flex-col items-center text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 w-full mb-7 text-left">
              {roleCards.map((card) => {
                ...
                return (
                  <div
                    ...
                    onDoubleClick={() => handleProceed(card.id)}
            ...
            {/* Motivational Tagline Under CTA */}
