  ...
  return (
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <div className="flex-1 overflow-auto p-4 bg-slate-100 flex justify-center preview-scroll-container">
        <div 
          ref={slipRef}
          className="w-[794px] min-h-[1123px] max-h-[1123px] h-[1123px] bg-white px-8 py-6 relative shadow-2xl overflow-hidden print-area flex flex-col justify-between"
          style={{ width: '794px', minHeight: '1123px', maxHeight: '1123px', height: '1123px', fontFamily: "'Inter', sans-serif" }}
        >
          {/* Header */}
          ...
          {/* Section 1: Student Profile & Demographics (Tightened spacing) */}
          <section className="bg-slate-50/70 rounded-xl p-3 border border-slate-200/80 mb-2 shadow-2xs">
          ...
          {/* Section 2: Academic Details (Tightened spacing) */}
          <section className="bg-slate-50/70 rounded-xl p-3 border border-slate-200/80 mb-2 shadow-2xs">
          ...
          {/* Section 4: Official Undertaking & Student / Guardian Declaration (Fills the previous empty gap!) */}
          <section className="bg-slate-50/80 rounded-xl p-3 border border-slate-200/90 mb-2 shadow-2xs">
          ...
          <div className="pt-2 border-t-2 border-slate-200 flex justify-between items-end">
            <div className="flex items-center gap-3">
              {qrCodeUrl && (
